<template>
    <div class="app-container">
        ...
        <el-dialog
            ...
            <img :src="editEmployee.idCardPicFace" style="width: 300px;height: 150px"/>
<img :src="editEmployee.idCardPic" style="width: 300px;height: 150px"/>
            <span slot="footer" class="dialog-footer">
              <el-button  type="success" @click="disabledialogVisible = false">通过</el-button>
              <el-button type="danger" @click="disabledialogVisible = false">失败</el-button>
...
<script>
  import { getEmployeeIdCardList,updateEmployeeJobStatus, updateEmployeeStatus } from '@/api/employee/employee'
